export const content = {
  ...
  majorSkills: [
    "ServiceNow", "ITSM", "ITOM", "Asset Management", "Discovery", "Linux", "Bash",
    "Knowledge Management", "Cloud Development", "AWS", "Microservices", "Git",
    "Lambda", "CSM", "Accessibility", "Html", "CSS", "JavaScript", "PWA", "React", "Vue"
  ],
  friends: "I am not looking for any new roles at the moment. How about you check out my friends for a fit on ",
  contact: {
    phone: "973 489 2670",
    email: "yawson@hey.com"
  },
  showcase: [
    {
      ...
      description: "A CI/CD pipeline for a microservices application using a rolling update deployment strategy. Using a defined scope, the project satisfies all business requirements.",
    ...
    },
    {
      ...
      description: "A set of data processing elements connected in series, where the output of one element is the input of the next one",
